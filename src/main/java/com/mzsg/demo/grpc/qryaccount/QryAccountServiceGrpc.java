...
public class QryAccountServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<QryAccountProto.AccountQryRequest,
      QryAccountProto.AccountQryResponse> METHOD_QRY =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "accountService.QryAccountService", "Qry"),
          io.grpc.protobuf.ProtoUtils.marshaller(QryAccountProto.AccountQryRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(QryAccountProto.AccountQryResponse.getDefaultInstance()));
  ...
  public static abstract class QryAccountServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void qry(QryAccountProto.AccountQryRequest request,
        io.grpc.stub.StreamObserver<QryAccountProto.AccountQryResponse> responseObserver) {
    ...
    @Override public io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                QryAccountProto.AccountQryRequest,
                QryAccountProto.AccountQryResponse>(
                  this, METHODID_QRY)))
          .build();
    }
  }
  ...
  public static final class QryAccountServiceBlockingStub extends io.grpc.stub.AbstractStub<QryAccountServiceBlockingStub> {
     ...
     * </pre>
     */
    public QryAccountProto.AccountQryResponse qry(QryAccountProto.AccountQryRequest request) {
  ...
  public static final class QryAccountServiceFutureStub extends io.grpc.stub.AbstractStub<QryAccountServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<QryAccountProto.AccountQryResponse> qry(
  ...
  private static class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_QRY:
          serviceImpl.qry((QryAccountProto.AccountQryRequest) request,
              (io.grpc.stub.StreamObserver<QryAccountProto.AccountQryResponse>) responseObserver);
          break;
        default:
