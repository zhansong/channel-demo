...
/**
 * Created by ZHANSONG on 2017/2/16.
 */
public class BitMap {
    ...
    public int getBit(long index) {
        ...
        int intData = (int) bitsMap[(int) ((index - 1) >> 5)];//11
    ...
    public void setBit(long index) {
        ...
        int belowIndex = (int) ((index - 1) >> 5);//1
        // 求出该值的偏移量(求余)
        int offset = (int) ((index - 1) & 31);//30
        int inData = bitsMap[belowIndex];//0
        bitsMap[belowIndex] = inData | BIT_VALUE[offset];//1073741824;
    }
